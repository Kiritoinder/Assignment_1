    ...
    public class Hero
    {
        ...
        */
        ...
        public void Fight()
        {
         ...
         /**
         * <summary>
         * This method calculates the Hero's Speed and displays it to the console.
         * </summary>
         * @method speed
         * @return {void}
         */
        public void speed()
        {
            if (this._speed <= 60)
            {
                Console.WriteLine("Awwwww____ Your Hero is Sooooo Slow -_-");
            }
            else
            {
                Console.WriteLine("OMG your Hero is Soooo Fast <_>");
            }
        }
        /**
         * <summary>
         * This method outputs the health of the Hero to the console.
         * </summary>
         * @method health 
         * @return {void}
         */
